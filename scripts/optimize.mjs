...
const searchMod = await server.ssrLoadModule('/src/lib/optimize/search.ts')
const gridMod = await server.ssrLoadModule('/src/lib/grid.ts')
const { DEFAULT_HARDWARE, DEFAULT_SPEED } = await server.ssrLoadModule('/src/state/defaults.ts')
const boards = await server.ssrLoadModule('/src/lib/boards.ts')
